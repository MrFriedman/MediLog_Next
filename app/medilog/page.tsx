      ...
      <div className="bg-pink-500 p-4">
        ...
        <div className="mb-8">
          ...
          <p className="mb-4 text-black">
            Please provide your consent to record the conversation for medical record purposes.
          </p>
          <form className="mb-4">
            <div className="mb-4">
              ...
              <input className="shadow appearance-none border rounded w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline" id="patient-name" placeholder="Enter your name" type="text" />
            </div>
            <div className="mb-4">
              <label className="block text-black text-sm font-bold mb-2">
                Doctor Name
              </label>
              <input className="shadow appearance-none border rounded w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline" id="doctor-name" placeholder="Enter doctor's name" type="text" />
            </div>
            <div className="mb-4">
              <label className="block text-black text-sm font-bold mb-2">
                Consent
              ...
              <span className="text-sm text-black">
                I consent to the recording of this conversation for medical record purposes.
              </span>
            </div>
